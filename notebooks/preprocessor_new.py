...
def process(waveform, samplingrate, max_length=132300):
    ...
    minmaxscaling(matrix, var, mode):
    
    spectogram_feat_norm = minmaxscaling(spectrogram_feat, "spectogram", "fit_transform")
    mfccs_norm = minmaxscaling(mfccs, "mfccs", "fit_transform")
    melspect_norm = minmaxscaling(melspect, "melspect", "fit_transform")
    chroma_padded_norm = minmaxscaling(chroma_padded, "chroma", "fit_transform")
